node {
  ...
  //   }
   ...
   stage('MERGE  to master branch') {
      ...
      sh "sed '/imagetag/d' /var/jenkins_home/workspace/k8stest-pipeline/helm-k8s-test-app/values.yaml > /var/jenkins_home/workspace/k8stest-pipeline/helm-k8s-test-app/values.yaml  "
